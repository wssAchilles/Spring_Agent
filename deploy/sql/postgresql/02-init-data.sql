...
VALUES (1, 1001, 'DeepSeek', 'DeepSeek', '深度求索提供的模型，如 deepseek-chat', 2, TRUE, FALSE, 'admin', CURRENT_TIMESTAMP, 'admin', CURRENT_TIMESTAMP);
...
VALUES (1, 1001, 1, 'deepseek-chat', 'deepseek-chat', 'DeepSeek', 1, 2, TRUE, FALSE, 'admin', CURRENT_TIMESTAMP, 'admin', CURRENT_TIMESTAMP);
