      ...
      <div  class="pagecont-bottom">
         ...
         <el-table stripe   v-loading="loading" :data="postList" @selection-change="handleSelectionChange" >
            ...
            <el-table-column label="操作" align="center" class-name="small-padding fixed-width"  fixed="right" width="240">
               <template #default="scope">
                  <el-button v-ripple class="glass-btn" link  @click="handleUpdate(scope.row)" v-hasPermi="['system:post:edit']">
                    <i class="iconfont-mini icon-a-xiugaixianxing"></i>
                    修改</el-button>
                  <el-button v-ripple class="glass-btn" link  @click="handleDelete(scope.row)" v-hasPermi="['system:post:remove']">
                    <i class="iconfont-mini icon-a-shanchuxianxing"></i>
                    删除</el-button>
               </template>
            </el-table-column>
