        ...
        <div class="pagecont-bottom">
          ...
          <el-table stripe v-loading="loading" :data="userList"
            ...
            <el-table-column label="用户编号" align="center" key="userId" prop="userId"
                             v-if="columns[0].visible" width="70"/>
            <el-table-column label="用户名称" align="center" key="userName" prop="userName"
                             v-if="columns[1].visible" :show-overflow-tooltip="true" min-width="85"/>
            <el-table-column label="用户昵称" align="center" key="nickName" prop="nickName"
                             v-if="columns[2].visible" :show-overflow-tooltip="true" min-width="85"/>
            <el-table-column label="部门" align="center" key="deptName" prop="dept.deptName"
                             v-if="columns[3].visible" :show-overflow-tooltip="true" min-width="85"/>
            <el-table-column label="手机号码" align="center" key="phonenumber" prop="phonenumber"
                             v-if="columns[4].visible" width="115"/>
            <el-table-column label="状态" align="center" key="status" v-if="columns[5].visible" width="65">
                  ...
                  <el-popover placement="bottom" :width="150" trigger="click" v-if="scope.row.userId !== 1">
                    ...
                    <div style="width: 90px;" class="butgdlist">
                      ...
                      <el-button v-ripple class="glass-btn" style="padding-left: 14px;" link
                                 ...
                                 v-hasPermi="['system:user:edit']">
                        <i class="iconfont-mini icon-a-jiaoseguanlixianxing"></i>
                        分配角色
                      </el-button>
                    </div>
                  </el-popover>
