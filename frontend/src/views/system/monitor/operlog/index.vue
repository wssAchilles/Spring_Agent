<template>
   <div class="app-container glass-card" ref="app-container">
      ...
      <div  class="pagecont-bottom">
         ...
         <el-table stripe   ref="operlogRef" v-loading="loading" :data="operlogList" @selection-change="handleSelectionChange" :default-sort="defaultSort" @sort-change="handleSortChange">
            ...
            <el-table-column label="操作" align="center" class-name="small-padding fixed-width"  fixed="right" width="240">
               <template #default="scope">
                  <el-button v-ripple class="glass-btn" link  @click="handleView(scope.row, scope.index)" v-hasPermi="['monitor:operlog:query']">
      ...
      <!-- 操作日志详细 -->
      <el-dialog class="glass-card" title="操作日志详细" v-model="open" width="800px" append-to="body"  draggable destroy-on-close>
