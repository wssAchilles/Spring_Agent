    ...
    <div  class="pagecont-bottom">
     <div class="justify-between mb15">
       <el-row :gutter="15" class="btn-style">
         <el-col :span="1.5">
           <el-button v-ripple class="glass-btn" plain @click="handleAdd" v-hasPermi="['ext:extDatasource:datasource:add']"
                      @mousedown="(e) => e.preventDefault()">
             <i class="iconfont-mini icon-xinzeng mr5"></i>新增
           </el-button>
         </el-col>
         <el-col :span="1.5">
           <el-button v-ripple class="glass-btn" plain :disabled="single" @click="handleUpdate" v-hasPermi="['ext:extDatasource:datasource:edit']"
                      @mousedown="(e) => e.preventDefault()">
             <i class="iconfont-mini icon-xiugai--copy mr5"></i>修改
           </el-button>
         </el-col>
         <el-col :span="1.5">
           <el-button v-ripple class="glass-btn" plain :disabled="multiple" @click="handleDelete" v-hasPermi="['ext:extDatasource:datasource:remove']"
                      @mousedown="(e) => e.preventDefault()">
             <i class="iconfont-mini icon-shanchu-huise mr5"></i>删除
           </el-button>
         </el-col>
<!--         <el-col :span="1.5">-->
<!--           <el-button v-ripple class="glass-btn" plain  @click="handleImport" v-hasPermi="['ext:extDatasource:datasource:export']"-->
<!--                      @mousedown="(e) => e.preventDefault()">-->
<!--             <i class="iconfont-mini icon-upload-cloud-line mr5"></i>导入-->
<!--           </el-button>-->
<!--         </el-col>-->
<!--         <el-col :span="1.5">-->
<!--           <el-button v-ripple class="glass-btn" plain @click="handleExport" v-hasPermi="['ext:extDatasource:datasource:export']"-->
<!--                      @mousedown="(e) => e.preventDefault()">-->
...
<!--         </el-col>-->
     ...
     <el-table class="glass-card" stripe  v-loading="loading" :data="datasourceList" @selection-change="handleSelectionChange" :default-sort="defaultSort" @sort-change="handleSortChange">
