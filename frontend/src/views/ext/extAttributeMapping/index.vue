    ...
    <div  class="pagecont-bottom">
     <div class="justify-between mb15">
       <el-row :gutter="15" class="btn-style">
         <el-col :span="1.5">
           <el-button v-ripple class="glass-btn" plain @click="handleAdd" v-hasPermi="['ext:extAttributeMapping:mapping:add']"
                      @mousedown="(e) => e.preventDefault()">
             <i class="iconfont-mini icon-xinzeng mr5"></i>新增
           </el-button>
         </el-col>
         <el-col :span="1.5">
           <el-button v-ripple class="glass-btn" plain :disabled="single" @click="handleUpdate" v-hasPermi="['ext:extAttributeMapping:mapping:edit']"
                      @mousedown="(e) => e.preventDefault()">
             <i class="iconfont-mini icon-xiugai--copy mr5"></i>修改
           </el-button>
         </el-col>
         <el-col :span="1.5">
           <el-button v-ripple class="glass-btn" plain :disabled="multiple" @click="handleDelete" v-hasPermi="['ext:extAttributeMapping:mapping:remove']"
                      @mousedown="(e) => e.preventDefault()">
             <i class="iconfont-mini icon-shanchu-huise mr5"></i>删除
           </el-button>
         </el-col>
         <el-col :span="1.5">
           <el-button v-ripple class="glass-btn" plain  @click="handleImport" v-hasPermi="['ext:extAttributeMapping:mapping:export']"
                      @mousedown="(e) => e.preventDefault()">
             <i class="iconfont-mini icon-upload-cloud-line mr5"></i>导入
           </el-button>
         </el-col>
         <el-col :span="1.5">
           <el-button v-ripple class="glass-btn" plain @click="handleExport" v-hasPermi="['ext:extAttributeMapping:mapping:export']"
                      @mousedown="(e) => e.preventDefault()">
     ...
     <el-table class="glass-card" stripe  v-loading="loading" :data="mappingList" @selection-change="handleSelectionChange" :default-sort="defaultSort" @sort-change="handleSortChange">
       ...
       <el-table-column label="操作" align="center" class-name="small-padding fixed-width" fixed="right" width="240">
         <template #default="scope">
           ...
           <el-button v-ripple class="glass-btn" link icon="view" @click="routeTo('/ext/extAttributeMapping/mappingDetail',scope.row)"
...
<script setup name="Mapping">
  ...
  const mockAttributeMappingData = [
    { id: 1, workspaceId: 1, taskId: 1, tableName: "t_user", tableComment: "用户表", fieldName: "user_name", fieldComment: "用户姓名", attributeId: 1, attributeName: "姓名", createBy: "admin", createTime: "2024-01-20 10:00:00", remark: "用户名映射到姓名属性" },
    { id: 2, workspaceId: 1, taskId: 1, tableName: "t_user", tableComment: "用户表", fieldName: "age", fieldComment: "年龄", attributeId: 2, attributeName: "年龄", createBy: "admin", createTime: "2024-01-20 10:05:00", remark: "年龄字段映射" },
    { id: 3, workspaceId: 1, taskId: 2, tableName: "t_disease", tableComment: "疾病表", fieldName: "disease_name", fieldComment: "疾病名称", attributeId: 3, attributeName: "疾病名称", createBy: "user1", createTime: "2024-02-01 14:30:00", remark: "疾病名称映射" },
    { id: 4, workspaceId: 1, taskId: 2, tableName: "t_disease", tableComment: "疾病表", fieldName: "symptom", fieldComment: "症状", attributeId: 4, attributeName: "症状描述", createBy: "user2", createTime: "2024-02-10 09:00:00", remark: "症状字段映射" },
    { id: 5, workspaceId: 1, taskId: 3, tableName: "t_device", tableComment: "器械表", fieldName: "model", fieldComment: "型号", attributeId: 5, attributeName: "器械型号", createBy: "admin", createTime: "2024-03-01 11:20:00", remark: "器械型号映射" },
  ];
  ...
  function getList() {
    ...
    listMapping(queryParams.value).then(response => {
      ...
      loading.value = false;
      mappingList.value = mockAttributeMappingData;
      total.value = mockAttributeMappingData.length;
