...
\begin{titlepage}
    \thispagestyle{empty}
    \newcommand\coverfield[3]{#1\underline{\parbox{#2}{\centering #3}}}
    \begin{tikzpicture}[remember picture,overlay]
        ...
        {\scalebox{1}[0.88]{\heiti\bfseries\fontsize{30pt}{36pt}\selectfont 实训报告}};
        ...
        {\songti\selectfont{\bfseries\fontsize{18pt}{34pt}\selectfont 课程名称：}%
            \underline{\makebox[94mm][c]{\fontsize{22pt}{30pt}\selectfont 工程项目训练}}};
        ...
        {\songti\fontsize{15pt}{18pt}\selectfont \coverfield{课题名称：\ }{82mm}{基于 RAG 与多智能体协作的\\知识服务平台}};

        \node[anchor=west] at ([xshift=52.6mm,yshift=-185.5mm]current page.north west)
        {\songti\fontsize{15pt}{18pt}\selectfont \coverfield{班\hspace{2em}级：\ }{82mm}{23软一}};

        \node[anchor=west] at ([xshift=52.6mm,yshift=-197.2mm]current page.north west)
        {\songti\fontsize{15pt}{18pt}\selectfont \coverfield{学\hspace{2em}号：\ }{82mm}{23030327}};

        \node[anchor=west] at ([xshift=52.6mm,yshift=-209.1mm]current page.north west)
        {\songti\fontsize{15pt}{18pt}\selectfont \coverfield{姓\hspace{2em}名：\ }{82mm}{许子祺}};

        \node[anchor=west] at ([xshift=52.6mm,yshift=-221.0mm]current page.north west)
        {\songti\fontsize{15pt}{18pt}\selectfont \coverfield{指导教师：\ }{82mm}{蒋巍\hspace{1em}奚吉}};
