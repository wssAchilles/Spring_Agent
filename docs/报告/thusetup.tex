...
% 优化中英混排与代码标识符断行，消除 Overfull / Underfull \hbox
...
\newcommand\course@report@title{基于 RAG 与多智能体协作的知识服务平台}
\newcommand\course@report@title@en{A Knowledge Service Platform Based on RAG and Multi-Agent Collaboration}
